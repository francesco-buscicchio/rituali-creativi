export const siteContent = {
  ...
  home: {
    ...
    rituali: {
      ...
      text:
        'Sono momenti in cui imparare un gesto tessile, lasciarsi accompagnare dal ritmo delle mani e ritrovare presenza. Si lavora a piccoli passi, con materiali scelti e una guida vicina, dentro un ambiente tranquillo e non giudicante.'
    }
  },
  values: [
    {
      title: 'Rallentare',
      text:
        'Un tempo protetto in cui uscire dalla fretta, respirare meglio e seguire il proprio ritmo.',
      icon: 'lucide:pause',
      accent: 'sage'
    },
    {
      ...
      text:
        'Punti semplici, materiali morbidi e oggetti che prendono forma senza bisogno di dimostrare nulla.',
    ...
    },
    {
      title: 'Stare insieme',
      text:
        'Poche persone alla volta, per conoscersi con naturalezza e dare spazio a tutte.',
  ...
  smallGroups: {
    ...
    text:
      'Gli incontri sono pensati per 4-5 persone. Questo permette di essere seguite davvero, fare domande, parlare oppure restare in silenzio mentre le mani lavorano.',
    ...
    details: [
      {
        title: 'Per chi è',
        text:
          'Per chi non ha mai preso in mano l’uncinetto, per chi vuole ricominciare senza pressione e per chi cerca un momento creativo semplice.'
      },
      {
        title: 'Come funziona',
        text:
          'Ogni incontro alterna spiegazione, pratica guidata e tempo libero per procedere con calma. Il gruppo resta piccolo per seguire ogni persona.'
      },
      {
        title: 'Cosa è incluso',
        text:
          'Filati, strumenti di base, dispense essenziali e una piccola guida per continuare anche a casa.'
      },
      {
        title: 'Cosa porti a casa',
        text:
          'Le basi dell’uncinetto, un primo progetto finito o avviato, e soprattutto un modo più gentile di stare nel fare.'
      }
    ],
    practicalDetails: [
  ...
  creations: {
    ...
    note:
      'Non c’è sovrapproduzione: alcuni pezzi sono disponibili in piccole quantità, altri possono essere richiesti su misura scegliendo colori, dimensioni e dettagli.',
    products: [
      {
