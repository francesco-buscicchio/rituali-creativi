globalThis.__timing__.logStart('Load chunks/_/icons');var prefix = "lucide";
var icons = {
	"a-arrow-down": {
...
export { aliases, icons_default as default, height, icons, lastModified, prefix, width };;globalThis.__timing__.logEnd('Load chunks/_/icons');
