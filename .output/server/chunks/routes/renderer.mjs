...
import { b as buildAssetsURL, p as publicAssetsURL, u as useRuntimeConfig, g as getResponseStatusText, a as getResponseStatus, e as encodePath, f as defineRenderHandler, h as getQuery, c as createError, i as getRouteRules, j as joinURL, k as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"theme-color","content":"#F7F3EE"},{"name":"color-scheme","content":"light"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"it"},"title":"Rituali Creativi","titleTemplate":"%s | Rituali Creativi"};
...
export { useSeoMeta as a, headSymbol as h, renderer as r, useHead as u };;globalThis.__timing__.logEnd('Load chunks/routes//renderer');
