globalThis.__timing__.logStart('Load chunks/build/FaqAccordion-CvRH6UAX');import { defineComponent, useId, ref, mergeProps, unref, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const props = __props;
    const uid = useId();
    const openIndex = ref((_a = props.initialOpen) != null ? _a : 0);
    return (_ctx, _push, _parent, _attrs) => {
...
export { _sfc_main as _ };;globalThis.__timing__.logEnd('Load chunks/build/FaqAccordion-CvRH6UAX');
//# sourceMappingURL=FaqAccordion-CvRH6UAX.mjs.map
