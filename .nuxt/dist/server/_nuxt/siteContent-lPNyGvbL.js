import { _ as __nuxt_component_0 } from "./nuxt-link-C54LFPTs.js";
...
const siteContent = {
  ...
  home: {
    hero: {
      ...
      subtitle: "Esperienze tessili e piccoli gruppi di uncinetto per chi sente il bisogno di un ritmo più umano.",
      primaryCta: "Scopri gli incontri",
      secondaryCta: "Scrivimi"
    },
    intro: "Rituali Creativi nasce per riportare le mani al centro: non per produrre di più, ma per stare meglio dentro un tempo semplice, condiviso e guidato con delicatezza.",
    rituali: {
  ...
  course: {
    ...
    subtitle: "Più che un corso classico, è uno spazio semplice in cui imparare con calma, fare qualcosa con le mani e staccare davvero per un paio d’ore.",
    standardPrice: "100€",
    launchPrice: "75€",
    duration: "4 incontri",
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "Sì, per il primo ciclo sono inclusi filati, strumenti di base e materiali utili per seguire l’esperienza."
    },
    {
      question: "Quante persone ci sono?",
      answer: "I gruppi sono piccoli, di solito 4-5 persone, così ogni partecipante può essere seguita con attenzione."
    },
    {
      question: "Quanto dura ogni incontro?",
      answer: "La durata precisa viene confermata in fase di iscrizione, ma l’idea è dedicare circa un paio d’ore a ogni incontro."
    },
    {
      question: "Dove si svolgono?",
      answer: "Gli spazi vengono comunicati quando il ciclo è in apertura. Puoi scrivere per sapere se c’è una data vicina a te."
    },
    {
      question: "Quanto costa?",
      answer: "Il prezzo standard del ciclo è 100€. Per il primo ciclo di lancio il prezzo promozionale è 75€, materiali inclusi."
    },
    {
      question: "Posso scriverti per capire se fa per me?",
      answer: "Certo. Puoi mandare un messaggio senza impegno: l’obiettivo è capire insieme se questo spazio risponde a ciò che cerchi."
    }
  ],
  contactReasons: [
  ...
  seo: {
    ...
    project: {
      title: "Il progetto",
      description: "Scopri la visione di Rituali Creativi: creatività lenta, connessione genuina e un modo più umano di stare nel fare."
    },
    meetings: {
...
//# sourceMappingURL=siteContent-lPNyGvbL.js.map
