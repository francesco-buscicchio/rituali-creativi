import { defineComponent, mergeProps, withCtx, unref, createTextVNode, toDisplayString, useSSRContext, computed, ref, watch, createVNode } from "vue";
...
import { _ as _sfc_main$4 } from "./SocialLinkItem-CunLXq1O.js";
import { s as siteContent, _ as _sfc_main$5 } from "./siteContent-lPNyGvbL.js";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div></div><div class="site-container border-t border-ink/10 py-5 text-sm text-ink/52"> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} ${ssrInterpolate(unref(siteContent).brand.name)}. Tutti i diritti riservati. </div></footer>`);
    };
  }
});
...
//# sourceMappingURL=default-BJqfZUZd.js.map
