import { defineComponent, useModel, mergeProps, mergeModels, useSSRContext, reactive, ref, computed, unref, withCtx, createTextVNode, toDisplayString } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderDynamicModel, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderComponent, ssrRenderClass } from "vue/server-renderer";
import { s as siteContent, _ as _sfc_main$4 } from "./siteContent-lPNyGvbL.js";
...
function useContactForm(options) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      serverMessage.value = options.endpoint === "/api/interest" ? "Richiesta ricevuta. Ti risponderò con i dettagli del prossimo ciclo." : "Messaggio ricevuto. Ti risponderò appena possibile.";
      reset();
    } catch {
      status.value = "error";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const intro = computed(
      () => isInterest.value ? "Lascia i tuoi dati e una breve nota. Ti risponderò con disponibilità, luogo e prossime date." : "Per incontri, creazioni su richiesta o collaborazioni, puoi usare questo spazio. Rispondo appena possibile."
    );
...
//# sourceMappingURL=ContactForm-CB4BiCXL.js.map
